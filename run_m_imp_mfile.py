# -*- coding: utf-8 -*-
"""
Created on Tue Sep 27 10:36:34 2022
...
def main():
    ...
    keras.utils.plot_model(model.model,
                            ...
                            expand_nested=True)
    # 多步长预测
    x, y = data.get_train_data(seq_len)
    x1, y1 = dataSmooth.get_train_data(seq_len)
...
# 	in-memory training5
    ...
    # 单点预测
    x_test, y_test = data.get_test_data(seq_len)
    x1_test, y1_test = dataSmooth.get_test_data(seq_len)
